...
<head>
	...
	<meta name="copyright" content="Ruukki" /> 
	<meta name="resource-type" content="document" /> 
	<meta http-equiv="pragma" content="no-cache" /> 
	<!--<base href="http://apps.ruukki.com/ruukki21/public_html/" />-->
	...
	<link rel="stylesheet" href="../ruukki21/public_html/css/jquery_tipsy.css" type="text/css" media="screen" />
</head>
<body>
...
<div id="wrapper">
		<div style="position: relative; width: 997px; height: 494px;">
									<script>
			actHouse = "H1";
			actRoofName = "Classic C";
			actRoof = "Classic";
			actRoofId = "7";
			actRoofColor = "RR11";
			actRoofColorName = "okkaroheline";
			actRWS = "rannitRR23";
			actRWSName = "tumehall";
			actWall = "WWhite";
			actAccess = "Accessories4824";
			rwslink = "http://www.ruukkikatus.ee/vihmaveesusteem";
							rooflinks[1] = "http://www.ruukkikatus.ee/teraskivi-premium";
							rooflinks[2] = "http://www.ruukkikatus.ee/finnera";
							rooflinks[3] = "";
							rooflinks[6] = "http://www.ruukkikatus.ee/decorrey-roof";
							rooflinks[8] = "http://www.ruukkikatus.ee/classic-d";
							rooflinks[7] = "http://www.ruukkikatus.ee/classic-c";
							rooflinks[9] = "http://www.ruukkikatus.ee/adamante";
							rooflinks[5] = "http://www.ruukkikatus.ee/t20-premium";
						rooftitle = "Katus";
			dealerid = 0;
			fb_share_title = "Disainige oma maja";
			fb_share_description = "Kasuta disainimise tööriista ja katseta erinevaid katuseprofiile ja värvitoone, mis võiksid sinu majaga sobida.";
			fb_share_page_text = "<A HREF=\"http://www.ruukkikatus.ee/Disainige-oma-maja\">Disainige oma maja<\/a>\r\n\r\nKasutage disainimise tööriista ja katsetage, milline Ruukki katuseprofiil ja värvitoon sobivad kõige paremini teie majale.";
		</script>
		<div onclick="closeChooser();" style="cursor: pointer;">
			<div id="house_main_div"><img src="../ruukki21/public_html/container/houses/house1pohja.png" id="house_main" /></div>
			<div id="roof_div"><img src="../ruukki21/public_html/cache/H1ClassicRR11.png" id="roof" /></div>
			<div id="access_div"><img src="../ruukki21/public_html/cache/H1Accessories4824.png" id="access" /></div>
			<div id="wall_div"><img src="../ruukki21/public_html/cache/H1WWhite.png" id="wall" /></div>
			<div id="rws_div"><img src="../ruukki21/public_html/cache/H1rannitRR23.png" id="rws" /></div>
		</div>
		<div>
			<div id="chooser_menu">
				<div id="menu_inner">
					<div id="houses" class="chooser_inner">
						<script>
							...
							allhouse = 804;
													...
													<img src="../ruukki21/public_html/container/houses/tn_house1pohja.png" onclick="changeHouse('H1', 'container/houses/house1pohja.png', 7, 20);" id="house_name_7" />
							<script>
								$('#house_name_7').tipsy(
									 { 
										fallback: '1', live: true, gravity: 's'
													...
													<img src="../ruukki21/public_html/container/houses/tn_house2pohja.png" onclick="changeHouse('H2', 'container/houses/house2pohja.png', 10, 20);" id="house_name_10" />
							<script>
								$('#house_name_10').tipsy(
									 { 
										fallback: '2', live: true, gravity: 's'
													...
													<img src="../ruukki21/public_html/container/houses/tn_house3pohja.png" onclick="changeHouse('H3', 'container/houses/house3pohja.png', 11, 20);" id="house_name_11" />
							<script>
								$('#house_name_11').tipsy(
									 { 
										fallback: '3', live: true, gravity: 's'
													...
													<img src="../ruukki21/public_html/container/houses/tn_house4pohja.jpg" onclick="changeHouse('H4', 'container/houses/house4pohja.jpg', 12, 20);" id="house_name_12" />
							<script>
								$('#house_name_12').tipsy(
									 { 
					...
					<div id="roof_profiles" class="chooser_inner">
						<script>
							...
							allroof = 1034;
													...
													<img src="../ruukki21/public_html/container/houses/adamante.png" onclick="changeRoof('Adamante', 9, '', 20);" id="roof_name_9" />
							<script>
								$('#roof_name_9').tipsy(
									 { 
										fallback: 'Adamante', live: true, gravity: 's'
													...
													<img src="container/houses/classic.png" onclick="changeRoof('Classic', 7, '', 20);" id="roof_name_7" />
							<script>
								$('#roof_name_7').tipsy(
									 { 
										fallback: 'Classic C', live: true, gravity: 's'
									 } 
								);
							</script>
													<img src="../ruukki21/public_html/container/houses/classicd.png" onclick="changeRoof('ClassicD', 8, '', 20);" id="roof_name_8" />
							<script>
								$('#roof_name_8').tipsy(
									 { 
										fallback: 'Classic D', live: true, gravity: 's'
													...
													<img src="../ruukki21/public_html/container/houses/decorrey.png" onclick="changeRoof('Decorrey', 6, '', 20);" id="roof_name_6" />
							<script>
								$('#roof_name_6').tipsy(
									 { 
										fallback: 'Decorrey', live: true, gravity: 's'
													...
													<img src="../ruukki21/public_html/container/houses/finnera.png" onclick="changeRoof('Finnera', 2, '', 20);" id="roof_name_2" />
							<script>
								$('#roof_name_2').tipsy(
									 { 
										fallback: 'Finnera', live: true, gravity: 's'
													...
													<img src="../ruukki21/public_html/container/houses/monterrey.png" onclick="changeRoof('Monterrey', 1, '', 20);" id="roof_name_1" />
							<script>
								$('#roof_name_1').tipsy(
									 { 
										fallback: 'Teraskivi', live: true, gravity: 's'
									 } 
								);
							</script>
													<img src="../ruukki21/public_html/container/houses/t20.png" onclick="changeRoof('T20', 5, '', 20);" id="roof_name_5" />
							<script>
								$('#roof_name_5').tipsy(
									 { 
					...
					<div id="roof_colors" class="chooser_inner">
			...
			<script>
				$('#arrow_left').tipsy( { 
					fallback: 'Eelmine', live: true, gravity: 'w'
				 } );
				
				$('#arrow_right').tipsy( { 
					fallback: 'Järgmine', live: true, gravity: 'e'
				 } );
				
				$('#close_btn').tipsy( { 
					fallback: 'Peida tööriistariba', live: true, gravity: 'e'
				 } );
			</script>
			...
			<div class="closeBtn" style="left: 965px;"><img src="images/close.png" onclick="closeChooser();" id="close_btn"></div>
			<div id="chooser_loader"><img src="images/sys/ajax-loader2.gif"></div>
		</div>
	</div>
	<div class="house_menu">
		<div style="float: left;">
			<div class="house_menu_item" onclick="showChooser('houses');">
				...
				<div class="menu_center" id="houses_center">Maja tüüp</div>
			...
			<div class="house_menu_item" onclick="showChooser('roof_profiles');">
				...
				<div class="menu_center" id="roof_profiles_center">Katuseprofiil</div>
				<div class="menu_right" id="roof_profiles_right"></div>
			</div>
			<div class="house_menu_item" onclick="loadRoofColors(actRoofId, 20);">
				<div class="menu_left" id="roof_colors_left"></div>
				<div class="menu_center" id="roof_colors_center">Katuse värvitoon</div>
				<div class="menu_right" id="roof_colors_right"></div>
			</div>
			<div class="house_menu_item" onclick="loadColors('rws', 20);">
				<div class="menu_left" id="rws_list_left"></div>
				<div class="menu_center" id="rws_list_center">Vihmaveesüsteemi värvitoon</div>
				<div class="menu_right" id="rws_list_right"></div>
			</div>
			<div class="house_menu_item" onclick="loadColors('wall', 20);">
				<div class="menu_left" id="wall_list_left"></div>
				<div class="menu_center" id="wall_list_center">Seina värvitoon</div>
				<div class="menu_right" id="wall_list_right"></div>
			</div>
			<div class="house_menu_item" onclick="loadColors('access', 20);">
				<div class="menu_left" id="access_list_left"></div>
				<div class="menu_center" id="access_list_center">Piirdeliistude värvitoon</div>
	...
	<div id="cover">
		<div id="loader" style="display: none; text-align: center; width: 100%; line-height: 494px;">
			<img src="images/sys/ajax-loader.gif" />
		</div>
	</div>
		...
		<div id="content1">
			<div id="content1_inside">
				...
				TEIE VALIK</h1>
				<p style="font-family: Arial, Helvetica; color: #222222; font-size: 12px; margin: 0 0 10px 0; color: #000; line-height: 16px;"><p>Lisainformatsiooni ja pilte valitud profiili kohta leiate tooteleheküljelt. Kasutage v&otilde;rdlustööriista, et erinevate profiilide tehnilisi n&auml;itajaid ja garantiiaegu v&otilde;rrelda.</p>
<p>Valitud tooted:</p></p>
				<span id="teaser_two_link3" class="link"><img class="dealer_icon" id="service_pic" src="images/service.png" style="vertical-align: middle;" /> <a target="_parent" href="javascript:void(0);" onclick="openCBEmail('contact_request.php?domain=ee', actHouse, actRoof, actRoofColor, actWall, actRWS, actAccess, 500);">Päringu vormile</a></span><br />
											</div>
		</div>
		
		<div id="content2">
			<div id="content2_inside">
				<h1 class="teaser_title">
				SAATKE PÄRING</h1>
				<p style="font-family: Arial, Helvetica; color: #222222; font-size: 12px; margin: 0 0 10px 0; color: #000; line-height: 16px;"><p>Pole vahet, kas renoveerite olemasolevat katust v&otilde;i ehitate uut maja, andke meile oma soovidest teada ning me teeme teile sobiva pakkumise.</p></p>			
				<span id="teaser_three_link1" class="link">
					<img class="dealer_icon" id="email_pic" src="images/email.png" style="vertical-align: middle;" />
					<a onclick="openCBEmail('email_popup.php?domain=ee', actHouse, actRoof, actRoofColor, actWall, actRWS, actAccess, 340);">Jaga disainitud maja e-postiga</a>
				</span>
				<div style="padding-top: 5px;">
					<img class="dealer_icon" src="images/facebook.png" style="vertical-align: middle;" />&nbsp;&nbsp;<span id="teaser_three_link2" class="link"><a onclick="shareFB(actHouse, actRoof, actRoofColor, actWall, actRWS, actAccess);">Jaga disainitud maja Facebookis</a></span>
				</div>
				<div style="padding-top: 5px;">
					<img class="dealer_icon" src="images/print.png" style="vertical-align: middle;" />&nbsp;&nbsp;<span id="teaser_three_link2" class="link"><a onclick="openCBPrint('printable.php?domain=ee', actHouse, actRoof, actRoofColor, actWall, actRWS, actAccess, 500);">Prindi</a></span>
				</div>
			</div>
		</div>
		
		<div id="content3">
			<div id="content3_inside"> 
				<h1 class="teaser_title">
				JAGA SÕPRADEGA</h1>
				<p style="font-family: Arial, Helvetica; color: #222222; font-size: 12px; margin: 0 0 10px 0; color: #000; line-height: 16px;">
					<p>Anna disainimise tööriistast teada oma perekonnale ja s&otilde;pradele.</p>
					<div><span id="roof_info_title"></span><span id="roof_info"></span></div>
					<div><span id="rws_info_title">Vihmaveesüsteem: </span><span id="rws_info"></span></div>
				</p>
				<span id="teaser_one_link1" class="link"><a onclick="logEvent('more information: roof');" target="_parent" href="">Lisainfo valitud katuseprofiili kohta</a></span>
				<br /><span id="teaser_one_link2" class="link"><a onclick="logEvent('more information: rws');" target="_parent" href="">Lisainfo vihmaveesüsteemi kohta</a></span>
				<br /><span id="teaser_one_link3" class="link"><a target="_parent" href=""></a></span>
				<br /><span id="teaser_one_link4" class="link"><a target="_parent" href=""></a></span>
			</div>
		</div>
	</div>
	</div>			<script>
			
			function logEvent(event_action) {
				_gaq.push(['_trackEvent', 'Ruukki Dreamhouse', event_action]);
			}
			
			var url = (window.location != window.parent.location) ? document.referrer: document.location;	
			var url = url.split("http://");
			fdomain = url[1].split("/");
			if (fdomain[0].indexOf("www.") != -1) {
				fdomain = fdomain[0].split("www.");
				fulldomain = fdomain[1];
			} else {
				fulldomain = fdomain[0];
			}
			
			var _gaq = _gaq || [];
			_gaq.push(['_setAccount', 'UA-32940452-1']);
			_gaq.push(['_trackPageview']);
			_gaq.push(['_setDomainName', fulldomain]);
			_gaq.push(["_setCustomVar", 1, "domain", "ee"]); 
